...
import org.demo.common.DownloadThread;
import org.demo.common.FileMD5Util;
...
//        long offset = CHUNK_SIZE * param.getChunk();
	...
	@Override
	public void uploadFileByMappedByteBuffers(MultipartFileParam param) throws IOException {
		String fileName = param.getName();
		String uploadDirPath = finalDirPath + param.getMd5();
		String tempFileName = fileName + "_tmp";
		File tmpDir = new File(uploadDirPath);
		File tmpFile = new File(uploadDirPath, tempFileName);
		DownloadThread downloadThread = new DownloadThread( param,finalDirPath);
